...
const Login = () => {
  ...
  const handleSumbit = (e) => {
    e.preventDefault();
    const logeduser = localStorage.getItem("result");
    console.log(logeduser)
     if(logeduser&& logeduser.length){
      const dev= JSON.parse(logeduser)
       if(dev.email===email && dev.password===password){
              navigate("/")
              console.log("dwadndjndwfndw",dev)
       }
    
     }
    // if (data.email === logeduser.email) {
    //   alert("sucess ");
    // } else {
    //   alert("invalid Email");
    // }
